...
@section('content')
    ...
    <main
        ...
        <div class="max-w-xl text-white">
            <h1 class="text-4xl md:text-5xl lg:text-6xl mb-5 md:mb-7 mt-12">
            ...
            <button
                class="animated-btn bg-[#2D2F33] rounded-3xl py-2 px-4 flex items-center gap-2 border-2 border-[#eab308] font-bold transition-transform hover:translate-y-1.5">
                Listen now
        ...
        <div class="flex justify-center md:justify-end">
            <img src="{{ asset('assets/mello.svg') }}" alt="Music" class="w-full max-w-xs md:max-w-sm lg:w-auto lg:max-w-lg">
        </div>
    </main>
