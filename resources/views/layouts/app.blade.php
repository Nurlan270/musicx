...
<div id="mobile-message"
    ...
    This website is not available on devices with small / medium screen size.
</div>
    ...
    <div id="labs-modal"
        ...
        <div class="relative bg-[#424242] rounded-lg w-1/3 p-6 z-10 border border-[#eab308]">
            ...
            <div class="mt-9 text-white font-medium">
                <p>Here, you can share your music, songs, or even gifs with us. If you have a tune or a gif you'd like
                    to
                    see on our website, simply send it over! With your permission, we'll proudly feature it.</p>
                <br>
                <p>We’re also open to ideas for making our site even better, so feel free to reach out with
                    suggestions.</p>
                <br>
                <p>Email us at <span class="font-medium hover:underline text-[#eab308] cursor-pointer px-1"><a
                            onclick="window.open(this.href, '_blank'); return false;"
                            href="mailto:feedback@nurlan.dev">feedback@nurlan.dev</a></span> or click the button below
                    to
                    get in touch.</p>
            </div>

            <div class="flex items-center justify-center mt-7">
                <a onclick="window.open(this.href, '_blank'); return false;" href="mailto:feedback@nurlan.dev"
